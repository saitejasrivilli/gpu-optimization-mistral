...
|--------------|----------------|-------------|
| With Instruction Tuning | 14.5% | 15.0% |
| Without Instruction Tuning | 59.0% | 70.0% |
...
|-----------|----------------|---------------|
| Max Signal (Full Model) | 130.8 | 0.24 |
| Shortest Path Only | 69.7 | 0.63 |
...
|---------|-------------|-----------------------|
| Full Model | 100.0% | 0.0% |
| No System Prompt | 90.0% | 10.0% |
